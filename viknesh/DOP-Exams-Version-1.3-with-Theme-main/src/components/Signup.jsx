...
import Textfield from './FormsUI/Textfield/textfield-component';
import TextfieldPassword from './FormsUI/Textfield/textfield-password-component';
import Select from './FormsUI/Select/select-component';
import DateTimePicker from './FormsUI/DataTimePicker/datepicker-component';
import Checkbox from './FormsUI/Checkbox/checkbox-component';
import Button from './FormsUI/Button/button-component';

import Radiobutton from './FormsUI/Radiobutton/radiobutton-component';
import RadiobuttonTextbox from './FormsUI/Radiobutton/radiobutton-textbox-component';
...
const FORM_VALIDATION = Yup.object().shape({
    ...
    personWithDisability: Yup.string()
        .required('*Mandatory Field'),

    disabilityDetails: Yup.string()
        .when('personWithDisability', {
            is: (val) => val === "Yes",
            then: Yup.string()
                .required('*Mandatory Field')
                .min(5, 'Details should be minimum 5 characters')
                .max(200, 'Details should be maximum 200 characters'),
        }
        ),
                                    ...
                                    <div>
                                        ...
                                        <Formik
                                            ...
                                            {(values) => {
                                                ...
                                                link.download = `${values.employeeNumber}-${values.employeeName}.json`;
                                                link.href = url;
                                                link.click();
                                            }}
                                                ...
                                                <Grid container spacing={2}>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Select
                                                            ...
                                                            label="Cadre"
                                                            options=
                                                            {["Postal Assistant", "Sorting Assistant", "Postman", "Mailguard"]}
                                                        />
                                                    </Grid>
